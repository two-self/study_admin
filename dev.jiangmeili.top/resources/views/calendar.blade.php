...
<head>
    ...
    <link href="{{ URL::asset('css/lib/fullcalendar.css')}}" rel='stylesheet' />
    <link href="{{ URL::asset('css/lib/fullcalendar.print.css')}}" rel='stylesheet' media='print' />
    
    <!-- this page specific styles -->
    <link rel="stylesheet" href="{{ URL::asset('css/compiled/calendar.css')}}" type="text/css" media="screen" />
                    ...
                    <div class="pop-dialog">
                        ...
                        <div class="body">
                            ...
                            <div class="messages">
                                ...
                                <a href="#" class="item">
                                    <img src="{{ URL::asset('img/contact-img2.png') }}" class="display" />
                                    <div class="name">Alejandra Galván</div>
                                    <div class="msg">
